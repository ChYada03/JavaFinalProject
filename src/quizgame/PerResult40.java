...
public class PerResult40 extends JFrame {
   ...
   /* public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    PerResult40 frame = new PerResult40(calculateScore);
    ...
    public PerResult40(CalculateScore calculateScore) {
        ...
        btnYes.setBounds(317, 474, 117, 49);
        ...
        btnYes.setIcon(new ImageIcon(PerResult40.class.getResource("/quizgame/TryagainPerYes.png")));
        contentPane.add(btnYes);

        JButton btnNo = new JButton();
        btnNo.setBounds(517, 474, 117, 49);
        ...
        btnNo.setIcon(new ImageIcon(PerResult40.class.getResource("/quizgame/TryagainPerNo.png")));
        ...
        lblBg.setIcon(new ImageIcon(PerResult40.class.getResource("/quizgame/PerResult40.png")));
