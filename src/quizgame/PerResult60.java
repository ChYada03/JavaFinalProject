...
public class PerResult60 extends JFrame {
  ...
  /*  public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    PerResult60 frame = new PerResult60(calculateScore);
    ...
    public PerResult60(CalculateScore calculateScore) {
        ...
        btnYes.setBounds(316, 470, 117, 49);
        ...
        btnYes.setIcon(new ImageIcon(PerResult60.class.getResource("/quizgame/TryagainPerYes.png")));
        contentPane.add(btnYes);

        JButton btnNo = new JButton();
        btnNo.setBounds(520, 470, 117, 49);
        ...
        btnNo.setIcon(new ImageIcon(PerResult60.class.getResource("/quizgame/TryagainPerNo.png")));
        ...
        lblBg.setBounds(0, -15, 946, 560);
        lblBg.setIcon(new ImageIcon(PerResult60.class.getResource("/quizgame/PerResult60.png")));
