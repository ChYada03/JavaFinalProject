...
public class LoveQuestions5 extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoveQuestions5 frame = new LoveQuestions5();
	...
	public LoveQuestions5(PointDistribution pointDistribution) {
		...
		lblBg.setIcon(new ImageIcon(LoveQuestions1.class.getResource("/quizgame/LoveQuestion5.png")));
