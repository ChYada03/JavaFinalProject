...
public class LoveQuestions6 extends JFrame {

	private JPanel contentPane;
    private PointDistribution pointDistribution;

    public LoveQuestions6(PointDistribution pointDistribution) {
		...
		lblBg.setIcon(new ImageIcon("src/quizgame/LoveQuestion6.png"));
