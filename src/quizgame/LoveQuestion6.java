...
public class LoveQuestion6 extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoveQuestion6 frame = new LoveQuestion6();
	 ...
	 * Create the frame.
	 */
	public LoveQuestion6(PointDistribution pointDistribution) {
		...
		lblBg.setIcon(new ImageIcon(LoveQuestions1.class.getResource("/quizgame/LoveQuestion6.png")));
