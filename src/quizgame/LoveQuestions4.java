...
public class LoveQuestions4 extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoveQuestions4 frame = new LoveQuestions4();
	 ...
	 * Create the frame.
	 */
	public LoveQuestions4(PointDistribution pointDistribution) {
		...
		lblBg.setIcon(new ImageIcon(LoveQuestions1.class.getResource("/quizgame/LoveQuestion4.png")));
