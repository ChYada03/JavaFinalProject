...
public class LoveQuestions4 extends JFrame {
    ...
    public LoveQuestions4(PointDistribution pointDistribution) {
		...
		lblBg.setIcon(new ImageIcon("src/quizgame/LoveQuestion4.png"));
