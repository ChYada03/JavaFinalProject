...
public class LoveQuestions3 extends JFrame {
    ...
    public LoveQuestions3(PointDistribution pointDistribution) {
        this.pointDistribution = pointDistribution;
    		...
    		lblBg.setIcon(new ImageIcon("src/quizgame/LoveQuestion3.png"));
