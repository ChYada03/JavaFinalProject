...
public class LoveResultC extends JFrame {
 ...
 /*   public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    LoveResultC frame = new LoveResultC(pointDistribution);
    ...
    public LoveResultC(PointDistribution pointDistribution) {
        ...
        btnYes.setBounds(327, 444, 117, 49);
        ...
        btnNo.setBounds(521, 444, 117, 49);
        ...
        lblResult.setBounds(843, -12, 89, 81);
        ...
        lblBg.setIcon(new ImageIcon("D:\\JavaFinalProject\\JavaFinalProject\\src\\quizgame\\ResultC.png"));
