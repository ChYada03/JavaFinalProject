...
public class PerResult20 extends JFrame {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    PerResult20 frame = new PerResult20(calculateScore);
    ...
    public PerResult20(CalculateScore calculateScore) {
        ...
        btnYes.setBounds(318, 473, 117, 49);
        ...
        btnYes.setIcon(new ImageIcon(PerResult20.class.getResource("/quizgame/TryagainPerYes.png")));
        contentPane.add(btnYes);

        JButton btnNo = new JButton();
        btnNo.setBounds(520, 473, 117, 49);
        ...
        btnNo.setIcon(new ImageIcon(PerResult20.class.getResource("/quizgame/TryagainPerNo.png")));
        ...
        lblBg.setIcon(new ImageIcon(PerResult20.class.getResource("/quizgame/PerResult20.png")));
