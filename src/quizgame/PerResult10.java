...
public class PerResult10 extends JFrame {
   ...
   /* public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    PerResult10 frame = new PerResult10(calculateScore);
    ...
    public PerResult10(CalculateScore calculateScore) {
        ...
        btnYes.setBounds(319, 473, 117, 49);
        ...
        btnYes.setIcon(new ImageIcon(PerResult10.class.getResource("/quizgame/TryagainPerYes.png")));
        contentPane.add(btnYes);

        JButton btnNo = new JButton();
        btnNo.setBounds(519, 473, 117, 49);
        ...
        btnNo.setIcon(new ImageIcon(PerResult10.class.getResource("/quizgame/TryagainPerNo.png")));
        ...
        lblBg.setIcon(new ImageIcon(PerResult10.class.getResource("/quizgame/PerResult10.png")));
