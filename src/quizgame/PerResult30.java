...
public class PerResult30 extends JFrame {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    PerResult30 frame = new PerResult30(calculateScore);
    ...
    public PerResult30(CalculateScore calculateScore) {
        ...
        btnYes.setBounds(318, 470, 117, 49);
        ...
        btnYes.setIcon(new ImageIcon(PerResult30.class.getResource("/quizgame/TryagainPerYes.png")));
        contentPane.add(btnYes);

        JButton btnNo = new JButton();
        btnNo.setBounds(521, 470, 117, 49);
        ...
        btnNo.setIcon(new ImageIcon(PerResult30.class.getResource("/quizgame/TryagainPerNo.png")));
        ...
        lblBg.setBounds(0, -19, 946, 564);
        lblBg.setIcon(new ImageIcon(PerResult30.class.getResource("/quizgame/PerResult30.png")));
